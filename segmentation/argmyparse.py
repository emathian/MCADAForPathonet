...
def get_common_training_parser(parser):
    ...
    parser.add_argument("--input_ch", type=int, default=3,
                        choices=[1, 3, 4])
    parser.add_argument('--train_img_shape', default=(256, 256), nargs=2, metavar=("W", "H"),
                        help="W H")
...
def get_src_only_training_parser(parser=None):
    ...
    parser.add_argument('src_dataset', type=str, choices=["gta", "city", "city16", "synthia", "BREAST_TUMOR"])
...
def get_da_base_training_parser(parser=None):
    ...
    parser.add_argument('src_dataset', type=str, choices=["gta", "city", "city16", "synthia", "BREAST_TUMOR"])
    parser.add_argument('tgt_dataset', type=str, choices=["gta", "city", "city16", "synthia", "IARC_LNEN" ])
